...
import cn.arsenals.rootarsenals.ui.screen.getManagerVersion
import java.io.File
...
fun getBugreportFile(context: Context): File {
    ...
    PrintWriter(FileWriter(buildInfo)).use { pw ->
        ...
        pw.println("RootArsenals: $ksuKernel")
    ...
    val targetFile = File(context.cacheDir, "RootArsenals_bugreport_${current}.tar.gz")
